...
export const STORY_CHARACTER_PRESETS_ENDPOINT = `${API_BASE_URL}/api/story/character-presets`;
export const STORY_CHARACTER_PRESETS_GENERATE_ENDPOINT = `${API_BASE_URL}/api/story/character-presets/generate`;
